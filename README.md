...
| [lsp_glsl](/plugins/lsp_glsl.lua?raw=1)               | GLSL                           | [glsl_analyzer](https://github.com/nolanderc/glsl_analyzer)                                                                                                                        | Linux, Mac, Windows |
...
| [lsp_sql](/plugins/lsp_sql.lua?raw=1)                 | SQL                            | [sqls](https://github.com/sqls-server/sqls)                                                                                                                                        | Linux, Mac, Windows |
...
| :------------------------------------ | :------------------------------------------ | :------------------ |
| [golang](/libraries/golang.lua?raw=1) | Go binaries for running go apps             | Linux, Mac, Windows |
